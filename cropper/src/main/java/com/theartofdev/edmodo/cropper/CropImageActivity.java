...
public class CropImageActivity extends AppCompatActivity
  ...
  ImageView cropImageId,rotateImageleftId,rotateImagerightId,rotateImagehorizontallyId,rotateImageverticallyId;
  @Override
  @SuppressLint("NewApi")
  public void onCreate(Bundle savedInstanceState) {
    ...
    cropImageId = (ImageView) findViewById(R.id.cropImageId);
    rotateImageleftId = (ImageView)findViewById(R.id.rotateImageleftId);
    rotateImagerightId = (ImageView)findViewById(R.id.rotateImagerightId);
    rotateImagehorizontallyId = (ImageView)findViewById(R.id.rotateImagehorizontallyId);
    rotateImageverticallyId = (ImageView)findViewById(R.id.rotateImageverticallyId);
    Bundle bundle = getIntent().getBundleExtra(CropImage.CROP_IMAGE_EXTRA_BUNDLE);
    mCropImageUri = bundle.getParcelable(CropImage.CROP_IMAGE_EXTRA_SOURCE);
    mOptions = bundle.getParcelable(CropImage.CROP_IMAGE_EXTRA_OPTIONS);
    cropImageId.setOnClickListener(new View.OnClickListener() {
      @Override
    ...
    rotateImageleftId.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        rotateImage(-mOptions.rotationDegrees);
      }
    });
    rotateImagerightId.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        rotateImage(mOptions.rotationDegrees);
      }
    });
    rotateImagehorizontallyId.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        mCropImageView.flipImageHorizontally();
      }
    });
    rotateImageverticallyId.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
