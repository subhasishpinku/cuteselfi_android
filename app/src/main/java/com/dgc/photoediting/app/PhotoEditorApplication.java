package com.dgc.photoediting.app;
...
import com.dgc.photoediting.custom.AnalyticsTrackerClass;
...
public class PhotoEditorApplication extends Application {
    ...
    public synchronized Tracker getGoogleAnalyticsTracker() {
        AnalyticsTrackerClass AnalyticsTrackerClass = com.dgc.photoediting.custom.AnalyticsTrackerClass.getInstance();
        return AnalyticsTrackerClass.get(com.dgc.photoediting.custom.AnalyticsTrackerClass.Target.APP);
    }
