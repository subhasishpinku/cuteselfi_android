...
public class BirthdayActivity extends AppCompatActivity {
    ...
    public void getfetchFrames(){
        if (Utility.checkConnectivity(getApplicationContext())) {
            ...
            PopupClass.showPopUpWithTitleMessageOneButton(BirthdayActivity.this, "Ok", "", "Sorry, No Internet connection found, Please check your network connection", "", new PopupCallBackOneButton() {
                @Override
