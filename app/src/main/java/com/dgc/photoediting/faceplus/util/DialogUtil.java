package com.dgc.photoediting.faceplus.util;
...
public class DialogUtil {
	...
	public AlertDialog showEditText(final TextView text, final OnEditModifComplateListener listener){
		...
		builder.setNegativeButton(activity.getResources().getString(R.string.canceling), new DialogInterface.OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
				// 取消重命名时候隐藏软键盘
				imm.hideSoftInputFromWindow(edit.getWindowToken(), 0);
