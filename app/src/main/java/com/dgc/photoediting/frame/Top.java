...
import com.dgc.photoediting.frame.ChooseFrameActivity;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

public class Top  extends Fragment implements OnBackClickListener {
...
//    }
    ...
    public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyView> {
        ...
        public void onBindViewHolder(final MyView holder, final int position) {
            ...
            if (holder.textView.getText().toString().equals("birthday")){
                holder.textView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        System.out.println("ListView"+  holder.textView.getText().toString());
//                        Intent oi=new Intent(getContext(), SplashActivity.class);
//                        startActivity(oi);
                        Intent i = new Intent(getContext(), ChooseFrameActivity.class);
                        startActivity(i);
                    }
                });
            }
